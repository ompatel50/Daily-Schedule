 ...
 * authenticated session user — and redirects to /signin when there is
 * none — so every existing call site is authentication-enforcing without
 * having been rewritten. See src/server/auth/current-user.ts.
 */
